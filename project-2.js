...
addBtn.addEventListener('click', function () {
    ...
    //Convert into object literal to push into local storage and then convert into an array by using array.from() func and retrieve title and text easily
    let detl = {
    ...
    //If notes does not exists then create an notes obj blank array
    if (notes == null) {
        notesObj = [];
    }
